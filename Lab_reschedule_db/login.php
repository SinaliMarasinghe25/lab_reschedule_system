...
<head>
    ...
    <title>Login - Lab Reschedule System</title>
    <style>
        ...
        * {
        ...
        .container {
            ...
            width: 90%;
            max-width: 380px;
            max-height: 90vh; /* Ensure it fits screen height */
        ...
        .logo-icon {
            ...
            font-weight: 700;
            color: white;
            box-shadow: 0 8px 16px rgba(6, 64, 43, 0.25);
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 16px rgba(6, 64, 43, 0.3);
        }
        ...
        .btn-secondary:hover {
            ...
            color: white;
            transform: translateY(-1px);
            box-shadow: 0 6px 12px rgba(61, 124, 71, 0.25);
        }
...
<body>
    ...
    <script>
        // Prevent page scroll and handle form submission
        ...
        function adjustContainerSize() {
            ...
            container.style.maxHeight = Math.min(viewportHeight * 0.95, 600) + 'px';
        }
